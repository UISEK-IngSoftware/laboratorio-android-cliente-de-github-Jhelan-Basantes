...
object RetrofitClient {
    ...
    fun createAuthenticadedClient(username: String, password: String): GithubApiService {
    ...
    fun getApiService(): GithubApiService {
        return apiService ?: throw IllegalStateException("El cliente de retrofit no pudo inicializarse  ")
    }
